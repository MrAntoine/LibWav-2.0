...
echo "<div class=\"register\">
        <h1>Pas encore inscrit(e) ?</h1><h3>Mais qu'attendez-vous ?</h3><h1>Inscrivez-vous vite ! </h1>";
echo "<form method=\"post\" action=\"index.php?action=register\" name=\"creation\">
            ...
            <input type=\"password\" required name=\"passwordconf\" id='password_check' placeholder=\"Confirmez votre mot de passe\">";
